...
function CategoriedPoke({pokemon,lastIndex, firstIndex, pokemonsPerPage, totalPokemons ,paginate}) {
...
<>
	  ...
	  {totalPokemons > 20 && <Paginations pokemonsPerPage={pokemonsPerPage} totalPokemons={totalPokemons} paginate ={paginate}/>}
